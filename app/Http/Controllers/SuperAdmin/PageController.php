...
class PageController extends Controller
{
    public function index()  {
        ...
        $volunteersMasaol = Volunteer::where('type', 'مسئول')->get();
    
        $volunteersMashroaaMasaol = Volunteer::where('type', 'مشروع مسئول')->get();
        ...
        $volunteers = Volunteer::whereBetween('vol_date', [$startOfMonth, $endOfMonth]);
        ...
        return view('super_admin.index',compact('statistics','percentage'));
    }
