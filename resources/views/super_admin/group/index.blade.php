        ...
        <table id="myTable" class="table-responsive myTable dark:text-white-light">
            <thead>
                <tr class="text-center">
                    <th class="text-center"><input type="checkbox" class="form-checkbox" id="all" /></th>
                    ...
                    <tr>
                        ...
                        <td >
                            <ul class="flex items-center justify-center gap-2">
                                ...
                                <li  x-data="modal">
                                    <a href="javascript:;"  x-tooltip="إضافة مدير" @click="toggle" >
                                        <svg  class="text-success" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0">
