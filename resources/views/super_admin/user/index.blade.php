...
@section('content')
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
        <li>
            <a href="javascript:;" class="text-primary hover:underline">المستخدمون </a>
        </li>
    ...
    <div class="flex flex-wrap mt-3 mb-5 " x-data="modal">
        ...
        @include('super_admin.user.create')
    </div>
        ...
        <table id="myTable" class="table-responsive myTable dark:text-white-light">
            <thead>
                <tr class="text-center">
                    ...
                    <th class="wd-25p text-center border-bottom-0">اسم المستخدم</th>
                    <th class="wd-25p text-center border-bottom-0">البريد الالكتروني</th>
                    <th class="wd-25p text-center border-bottom-0">الدور</th>
...
@section('script')
    ...
    <script>
        async function showDeleteAlert(id) {
            const url = "{{ route('super_admin.user.destroy', ['user' => ':id']) }}".replace(':id',
                id);
