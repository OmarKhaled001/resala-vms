    ...
    <form class="mt-5" autocomplete="off" action="{{ route('super_admin.activity.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input name="username" type="text" placeholder="ادخل اسم المستخدم" class="form-input" autocomplete="off">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4">
            @foreach ($sections as $section)
                <label class="inline-flex">
                    <input name="section_id[]" value="{{ $section->id }}" type="checkbox" class="form-checkbox rounded-full item-checkbox"  />
