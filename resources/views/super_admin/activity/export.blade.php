            ...
            <div class="p-5">
                ...
                <div class="dark:text-white-dark/70 text-base font-medium text-[#1f2937]">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <label class="inline-flex">
                                <input name="columns[]" value="username" type="checkbox" class="form-checkbox rounded-full item-checkbox"  />
                                <span>اسم المستخدم</span>
                            </label>
                            <label class="inline-flex">
                                <input name="columns[]" value="email" type="checkbox" class="form-checkbox rounded-full item-checkbox"  />
