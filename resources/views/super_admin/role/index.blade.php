...
@section('content')
    ...
    <div class="flex flex-wrap mt-3 mb-5 " x-data="modal">
        <a href="{{ route('super_admin.role.create') }}" class="btn btn-outline-primary">إضافة</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <ul class="flex items-center justify-center gap-2">
                                <li x-data="modal">
                                    <a href="{{ route('super_admin.role.edit',$role->id) }}" @click="toggle" x-tooltip=" تعديل" class="hover:text-info">
