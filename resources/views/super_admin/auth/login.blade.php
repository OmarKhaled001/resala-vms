...
<html lang="ar" dir="rtl">
    <head>
        ...
        <title>تسجيل الدخول - الادارة المركزية</title>
                        ...
                        >
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="{{ route('home') }}" class="block w-48 lg:w-72 ms-10">
                                    <img src="{{ asset('assets') }}/images/auth/logo-white.svg" alt="Logo" class="w-full" />
                                </a>
                                <div class="mt-24 hidden w-full max-w-[430px] lg:block">
                                    <img src="{{ asset('assets') }}/images/auth/login.svg" alt="Cover Image" class="w-full" />
                                </div>
                            </div>
                        </div>
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    ...
                                    <p class="text-base font-bold leading-normal text-white-dark">لوحة تحكم الادارة المركزية</p>
                                </div>
                                <form action="{{ route('super_admin.login') }}" method="POST">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="text" name="username" placeholder="ادخل البريد الإلكتروني" class="form-input ps-10 placeholder:text-white-dark" />
                            ...
                            <p class="absolute bottom-6 w-full text-center dark:text-white">
                                © <span id="footer-year">2025</span>. Resala All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
