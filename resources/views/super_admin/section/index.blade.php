...
@section('content')
    ...
    <ul class="flex space-x-2 rtl:space-x-reverse">
        <li>
            <a href="javascript:;" class="text-primary hover:underline">اللجان </a>
        </li>
                            ...
                            <ul class="flex items-center justify-center gap-2">
                                ...
                                <li>
                                    <a href="javascript:;" x-tooltip="حذف"
                                        @click="showDeleteAlert({{ $section->id }})">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
...
@section('script')
    ...
    <script>
        async function showDeleteAlert(id) {
            const url = "{{ route('super_admin.section.destroy', ['section' => ':id']) }}".replace(':id',
                id);
